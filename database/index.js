...
const parameterizedQuery = async (queryString, params, response) => {
    console.log("SQL Query: ", queryString);
    console.log("SQL Parameters: ", params); // SQL 파라미터 로그
...
export { config, pool, query,parameterizedQuery  };